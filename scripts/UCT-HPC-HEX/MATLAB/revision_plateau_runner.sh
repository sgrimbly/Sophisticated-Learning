...
declare -a SEEDS=({1..30})

export ROOT_FOLDER="/home/grmstj001"
export SCRIPT_PATH="$ROOT_FOLDER/MATLAB-experiments/Sophisticated-Learning/src/MATLAB"
export RESULTS_ROOT="$ROOT_FOLDER/MATLAB-experiments/Sophisticated-Learning/results/unknown_model/MATLAB/revision_plateau_default_env"
export TIME_LIMIT="72:00:00"
export MAX_SLOTS=120

export GRID_ID="default_env_revision_plateau_hor9_t300"
export GRID_SIZE=10
export START_POS=51
export HILL=55
...
export SL_LOG_METRICS=0

RUN_LABEL="revision_plateau_defaultenv_h${HORIZON}_t${NUM_TRIALS}_s1-30"
