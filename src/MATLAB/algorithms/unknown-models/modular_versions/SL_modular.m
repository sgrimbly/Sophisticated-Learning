function [survived] = SL_modular(seed, grid_size, start_position, hill_pos, food_sources, water_sources, sleep_sources, weights, num_states, num_trials, grid_id, results_file_override)
    ...
    result_file = strcat(directory_path, '/SL_Seed_', num2str(seed), '_GridID_', grid_id_safe, '_Cfg_', config_id, '_', current_time, '.txt');
    ...
    stateFile = strcat(directory_path, '/SL_Seed_', num2str(seed), '_GridID_', grid_id_safe, '_Cfg_', config_id, '.mat')
