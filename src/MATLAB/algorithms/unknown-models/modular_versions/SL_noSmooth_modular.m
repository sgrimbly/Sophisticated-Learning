function [survived] = SL_noSmooth_modular(seed, grid_size, start_position, hill_pos, food_sources, water_sources, sleep_sources, weights, num_states, num_trials, grid_id)
    ...
    result_file = strcat(directory_path, '/SL_noSmooth_Seed_', num2str(seed), '_GridID_', grid_id, '_' , current_time, '.txt');
    ...
    stateFile = strcat(directory_path, '/SL_noSmooth_Seed_', num2str(seed), '_GridID_', grid_id, '.mat')
